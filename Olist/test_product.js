...
async function testProduct() {
    ...
    const pid = 891349066;
    const res = await fetch(`https://erp.tiny.com.br/public-api/v3/produtos/${pid}`, { headers: { 'Authorization': `Bearer ${config.access_token}` } });
    const det = await res.json();
    console.log("Detalhes do produto:", JSON.stringify(det, null, 2));
}
